...
void GraphicsEngine::drawRaycast(const SDL_Rect& b, const Point2& start)
{
	Point2 lineStart = { start.x, start.y };
	Rectangle2 rect = { b.x, b.y, b.h, b.w };
	SDL_RenderDrawLine(renderer, lineStart.x, lineStart.y, rect.x + rect.h/2, rect.y);
}
