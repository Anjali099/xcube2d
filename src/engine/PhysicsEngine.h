...
public:
	...
	int x, y, w, h;
	Block(int x, int y, int w, int h, SDL_Color c, int t);
...
public:
	...
	void drawBlocksArray(Block a);
	// add block objects and do the raycast
	//maybe have a draw line func
	//void drawraycastLine(Block b); // draw the feking line plz
	int x, y;
